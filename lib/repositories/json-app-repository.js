  ...
  return {
    async createOwnerAccount(payload) {
      return withDb((db) => {
        ...
        const hasExplicitTrialWindow =
          Object.prototype.hasOwnProperty.call(payload, "trialStartsAt") ||
          Object.prototype.hasOwnProperty.call(payload, "trialEndsAt");
        const trial = hasExplicitTrialWindow
          ? {
        ...
        const company = {
          ...
          billingDocumentId: String(payload.billingDocumentId || "").trim(),
          ...
          planCode: String(payload.plan || "").trim() || "professional",
          ...
          billingProvider: String(payload.billingProvider || "").trim().toLowerCase(),
          billingCustomerId: String(payload.billingCustomerId || "").trim(),
          billingSubscriptionId: String(payload.billingSubscriptionId || "").trim(),
          googleCalendar: {
            connected: false,
            calendarId: "",
            accountEmail: "",
